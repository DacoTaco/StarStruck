...
static const u8 OTP_Dummy_CommonKey[OTP_COMMONKEY_SIZE] = { 0xeb, 0xe4, 0x2a, 0x22, 0x5e, 0x85, 0x93, 0xe4,
	                                                        0x48, 0xd9, 0xc5, 0x45, 0x73, 0x81, 0xaa, 0xf7 };
static const u8 OTP_Dummy_NgPrivKey[OTP_NGPRIVKEY_SIZE] = { 0x00, 0x4d, 0x4c, 0x1e, 0xa0, 0xb1, 0x76, 0xe3,
	                                                        0xdd, 0xfb, 0xf8, 0x2e, 0xa3, 0x86, 0x14, 0x66,
	                                                        0xf1, 0xd4, 0xc1, 0xe6, 0x4e, 0x39, 0x83, 0xc8,
	                                                        0x57, 0x07, 0x2b, 0xda, 0x4e, 0x8f };
static const u8 OTP_Dummy_NandKey[OTP_NANDKEY_SIZE] = { 0xc1, 0x81, 0x6a, 0xf7, 0xa2, 0x70, 0xd6, 0x1d,
	                                                    0xd3, 0xbd, 0xa1, 0xe8, 0x41, 0xc9, 0x6c, 0x3f };
static const u8 OTP_Dummy_NandHmac[OTP_NANDHMAC_SIZE] = { 0x68, 0x6a, 0x69, 0x88, 0x9e, 0xbf, 0x1e,
	                                                      0x74, 0xe9, 0x17, 0x8e, 0xd7, 0x32, 0x27,
	                                                      0x0e, 0x2c, 0xcb, 0x0a, 0x9f, 0x55 };
static const u8 OTP_Dummy_RngSeed[OTP_RNGSEED_SIZE] = { 0xc4, 0x98, 0x73, 0x85, 0xe8, 0x65, 0xac, 0xa4,
	                                                    0x90, 0xa4, 0xfa, 0x2c, 0x89, 0xa5, 0x53, 0x66 };
...
void OTP_FetchData(u32 addr, void* out, u32 size)
{
	...
	while (size != 0)
	{
		OTPCommand command = { .Fields = { .IsRead = 1, .Address = addr & 0x1F } };
