...
#define ARGEXTRACT_EVEN(...) \
	ARGEXTRACT_EVEN_LOOP_BODY(__VA_ARGS__, ) ARGEXTRACT_EVEN_LOOP_B
#define ARGEXTRACT_EVEN_LOOP_B(...) \
	ARGEXTRACT_EVEN_LOOP_BODY(__VA_ARGS__, 0) ARGEXTRACT_EVEN_LOOP_C
#define ARGEXTRACT_EVEN_LOOP_C(...) \
	ARGEXTRACT_EVEN_LOOP_BODY(__VA_ARGS__, 0) ARGEXTRACT_EVEN_LOOP_B
#define ARGEXTRACT_EVEN_END
#define ARGEXTRACT_EVEN_LOOP_B_END
#define ARGEXTRACT_EVEN_LOOP_C_END

#define ARGEXTRACT_FULL(...) \
	ARGEXTRACT_FULL_LOOP_BODY(__VA_ARGS__, ) ARGEXTRACT_FULL_LOOP_B
#define ARGEXTRACT_FULL_LOOP_B(...) \
	ARGEXTRACT_FULL_LOOP_BODY(__VA_ARGS__, 0) ARGEXTRACT_FULL_LOOP_C
#define ARGEXTRACT_FULL_LOOP_C(...) \
	ARGEXTRACT_FULL_LOOP_BODY(__VA_ARGS__, 0) ARGEXTRACT_FULL_LOOP_B
