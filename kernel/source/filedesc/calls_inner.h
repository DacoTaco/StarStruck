...
DEFINE_FD_FUNCS(s32, Ioctl,
                (s32, fd)(u32, requestId)(void*, inputBuffer)(u32, inputBufferLength)(void*, outputBuffer)(u32, outputBufferLength))
DEFINE_FD_FUNCS(s32, Ioctlv,
                (s32, fd)(u32, requestId)(u32, vectorInputCount)(u32, vectorIOCount)(IoctlvMessageData*, vectors))
