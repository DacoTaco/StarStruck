...
typedef int (*request_handler)(ipcreq* request, unsigned char* do_reply);
typedef int (*request_open)(char* filepath, u32 mode, unsigned char* do_reply);

typedef struct _IosModule {
	const char* device_name;
	request_handler handle_request; 
	request_open handle_open;
} ios_module;
