...
#define CLUSTER_MASK          ((u32)(~CLUSTER_SIZE) + 1)
#define CLUSTER_SIZE_SHIFT    0x0E

// Size of the NAND system area (1MB) that precedes the user data area
#define NAND_SYSTEM_AREA_SIZE 0x100000

// Unsure if the 0x198 thing is correct or an IOS bug?
#define COPY_COMMAND_LOG_SIZE 0x198
