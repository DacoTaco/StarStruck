...
const NandInformation SupportedNandChips[10] MODULE_DATA = {
 // Hynix HY27US0812(1/2)B
	{ .Info = { .ChipId = 0xAD76,
	            ...
	            .Unknown6 = { 0xfe, 0x1d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1a,
 ...
 // Hynix HY27UF081G2A
	{ .Info = { .ChipId = 0xADF1,
	            ...
	            .ReadStatusPrefix = 0x70,
	            .Unknown6 = { 0xfe, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1b,
 ...
 // Hynix HY27UF084G2M or HY27UG084G2M
	{ .Info = { .ChipId = 0xADDC,
	            ...
	            .RandomDataInput = 0x85,
	            .ReadStatusPrefix = 0x70,
	            .Unknown6 = { 0xfe, 0x1f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1d,
	                          0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x0b,
	                          0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x05,
	                          0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
	            .ChipType = 0x07,
 ...
 // Samsung K9F1208U0C
	{ .Info = { .ChipId = 0xEC76,
	            ...
	            .RandomDataInput = 0xFE,
	            .ReadStatusPrefix = 0x70,
	            .Unknown6 = { 0x71, 0x1d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1a,
	                          0x00, 0x00, 0x00, 0x0e, 0x00, 0x00, 0x00, 0x09,
	                          0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x02,
 ...
 // Samsung K9F2G08U0A
	{ .Info = { .ChipId = 0xECDA,
	            ...
	            .RandomDataInput = 0x85,
	            .ReadStatusPrefix = 0x70,
	            .Unknown6 = { 0xfe, 0x1f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1c,
	                          0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x0b,
	                          0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x05,
	                          0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
	            .ChipType = 0x04,
...
s32 SendCommand(u8 cmd, u32 address, u32 flags, u32 dataLength)
{
	...
	s32 ret = 0;
	NandCommand command = { .Fields = { .Execute = 1,
